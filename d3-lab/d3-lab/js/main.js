...
(function(){
        ...
        //Global variables for data join from csv file
        var attrArray = ["Low Income Population with Low Access to Grocery Stores", "Black Population with Low Access to Grocery Stores", "Hispanic Population with Low Access to Grocery Stores", "Multiracial Population with Low Access to Grocery  Stores", "Senior Population with Low Access to Grocery Stores"];
    ...
    //function for background graticules
    ...
    //joins the spatial shapefile of Wisconsin and the csv data for food access
    ...
    //Sets the enumaration units for the map
    function setEnumerationUnits(wisconsinRegion, map, path, colorScale){
        ...
        var regions = map.selectAll(".regions")
            ...
            .attr("class", function(d){
                 var id  = 'a' + d.properties.COUNTY_FIP.toString();
                return "regions " + id;
            })
            .attr("d", path)
    ...
    //function to create color scale generator from color brewer
    ...
    function setChart(csvData, colorScale){
        ...
        var bars = chart.selectAll(".bars")
            ...
            .attr("class", function(d){
                var id = 'a'+ d.COUNTY_FIP.toString();
                return "bars " + id;
            })
    ...
    function changeAttribute(attribute, csvData){
        ...
        //calls the update function and sets the variables
    ...
    function highlight(props){
        //change stroke
        var selected = d3.selectAll(".a" + props.COUNTY_FIP.toString())
            .style("stroke", "blue")
